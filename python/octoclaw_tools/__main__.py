"""
CLI entry point for octoclaw-tools.
"""
...
DEFAULT_SYSTEM_PROMPT = """You are OctoClaw, an AI assistant with full system access. Use tools to accomplish tasks.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="OctoClaw Tools - LangGraph-based tool calling for LLMs"
    )
    parser.add_argument(
        "message",
        nargs="*",
...
def main(argv: list[str] | None = None):
    ...
    if args.interactive:
        print("OctoClaw Tools CLI (Interactive Mode)")
