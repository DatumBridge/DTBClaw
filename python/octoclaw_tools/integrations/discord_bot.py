"""
Discord bot integration for OctoClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by OctoClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install octoclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"OctoClaw Discord Bot ready: {self.client.user}")
