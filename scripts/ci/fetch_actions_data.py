...
Options:
    ...
    --repo OWNER/NAME   Repository (default: octoclaw-labs/octoclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="octoclaw-labs/octoclaw",
        help="Repository in OWNER/NAME format (default: octoclaw-labs/octoclaw)",
    )
