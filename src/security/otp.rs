...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(octoclaw_dir);
...
pub fn secret_file_path(octoclaw_dir: &Path) -> PathBuf {
    octoclaw_dir.join(OTP_SECRET_FILE)
}
