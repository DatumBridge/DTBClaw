...
//!
//! Provides two endpoints for callers migrating from OpenClaw to OctoClaw:
//!
//! 1. **`POST /api/chat`** (recommended) — OctoClaw-native endpoint that invokes the
...
//! OctoClaw's existing `/v1/chat/completions` (in `openai_compat.rs`) uses the
...
// ══════════════════════════════════════════════════════════════════════════════
// /api/chat — OctoClaw-native endpoint
// ══════════════════════════════════════════════════════════════════════════════
...
pub struct ApiChatBody {
    ...
    /// Use this to inject recent conversation history that OctoClaw's
...
/// `POST /v1/chat/completions` — OpenAI-compatible shim over OctoClaw's agent loop.
///
...
/// the same tools + memory experience as native OctoClaw channels.
