...
const SNAPSHOT_HEADER: &str = "# 🧠 OctoClaw Memory Snapshot\n\n\
    > Auto-generated by OctoClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 OctoClaw Memory Snapshot

> Auto-generated by OctoClaw.
...
I am OctoClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 OctoClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
