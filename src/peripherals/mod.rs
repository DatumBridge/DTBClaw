...
/// Handle `octoclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: octoclaw peripheral add <board> <path>");
                println!("  Example: octoclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
