...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/octoclaw/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to OctoClaw tool names.
...
/// to. This function encodes the mapping for known OctoClaw tools.
...
pub(super) fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. OctoClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
