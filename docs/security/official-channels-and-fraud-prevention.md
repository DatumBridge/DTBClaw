...
Scammers may impersonate OctoClaw maintainers, contributors, or community members.

Assume fraud if someone claiming to represent OctoClaw asks for:
...
OctoClaw maintainers do not request money or private wallet/financial credentials via direct messages.

## Official Sources Of Truth

Use these sources to verify announcements:

- GitHub repository: `octoclaw-labs/octoclaw`
...
3. Open a GitHub issue in `octoclaw-labs/octoclaw` with sanitized details.
