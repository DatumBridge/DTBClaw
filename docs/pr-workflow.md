# OctoClaw PR Workflow (High-Volume Collaboration)

This document defines how OctoClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to OctoClaw/project-native labels.
...
- Confirm any required identity-like wording uses OctoClaw/project-native terminology.
