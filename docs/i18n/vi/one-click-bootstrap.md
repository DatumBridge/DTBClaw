...
Cách cài đặt và khởi tạo OctoClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài OctoClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image OctoClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.octoclaw-docker`.
