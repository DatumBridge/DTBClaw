...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `octoclaw onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `octoclaw onboard --interactive` |
| Đã có config, chỉ cần sửa kênh | `octoclaw onboard --channels-only` |
...
- Thiết lập nhanh: `octoclaw onboard --api-key "sk-..." --provider openrouter`
- Thiết lập tương tác: `octoclaw onboard --interactive`
- Kiểm tra môi trường: `octoclaw status` + `octoclaw doctor`
