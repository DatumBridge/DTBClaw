...
|---------|-----------|--------------|--------|
| **OctoClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | OctoClaw (cơ bản) | OctoClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, OctoClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của OctoClaw: hoán đổi bất kỳ thứ gì
