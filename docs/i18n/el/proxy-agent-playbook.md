...
- **Κοινό**: Διαχειριστές συστημάτων και συντηρητές που λειτουργούν το OctoClaw σε εταιρικά ή περιορισμένα δίκτυα.
...
### 1.1 Proxy μόνο για το OctoClaw (Internal Traffic)

- **Περιγραφή**: Διαμεσολάβηση μόνο για την εσωτερική κίνηση του δαίμονα.
- **Εμβέλεια (Scope)**: `octoclaw`.
...
|:---|:---|:---:|:---|
| `octoclaw` | Εσωτερικοί HTTP clients | Όχι | Αποφυγή παρενεργειών στο σύστημα. |
...
### Λειτουργία Α: Εσωτερική Διαμεσολάβηση (OctoClaw only)
