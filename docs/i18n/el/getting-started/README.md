...
Οδηγίες για την αρχική εγκατάσταση και την εξοικείωση με το οικοσύστημα του OctoClaw.
...
|:---|:---|
| Διαθέτω API Key και επιθυμώ άμεση ρύθμιση | `octoclaw onboard --api-key sk-... --provider openrouter` |
| Επιθυμώ διαδραστική καθοδήγηση (Step-by-step) | `octoclaw onboard --interactive` |
| Επιθυμώ μόνο τη ρύθμιση καναλιών επικοινωνίας | `octoclaw onboard --channels-only` |
| Επιθυμώ πλήρη αντικατάσταση υπαρχουσών ρυθμίσεων | `octoclaw onboard --force` |
...
- **Έλεγχος Υγείας**: Μετά την εγκατάσταση, εκτελέστε τις εντολές `octoclaw status` και `octoclaw doctor` για την επαλήθευση της σωστής λειτουργίας.
