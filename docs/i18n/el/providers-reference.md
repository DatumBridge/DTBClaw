# Αναφορά Παρόχων OctoClaw (Providers Reference)
...
Το runtime του OctoClaw αναζητά διαπιστευτήρια με την εξής σειρά προτεραιότητας:
...
3. **Γενικές μεταβλητές**: Εφεδρικές μεταβλητές όπως οι `OCTOCLAW_API_KEY` ή `API_KEY`.
...
- Τα μοντέλα συλλογιστικής (thinking models) υποστηρίζονται εγγενώς· το OctoClaw φιλτράρει αυτόματα τα εσωτερικά metadata της συλλογιστικής.
...
Κλήση μέσω CLI: `octoclaw agent --model hint:fast --message "..."`.
