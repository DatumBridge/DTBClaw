...
- [H3 · 1.1 Proxy only OctoClaw internal traffic](../../proxy-agent-playbook.md#1-1-proxy-only-octoclaw-internal-traffic)
...
- [H2 · 4. Mode A — Proxy Only for OctoClaw Internals](../../proxy-agent-playbook.md#4-mode-a-proxy-only-for-octoclaw-internals)
