...
## Problem
OctoClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/octoclaw/audit.key"
...
octoclaw audit --user @alice

# Show all high-risk commands
octoclaw audit --risk high

# Show violations from last 24 hours
octoclaw audit --since 24h --violations-only

# Export to JSON for analysis
octoclaw audit --format json --output audit.json
