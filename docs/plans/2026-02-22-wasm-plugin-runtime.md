...
existing OctoClaw traits/factories.
...
- Create: `wit/octoclaw/hooks/v1/*.wit`
- Create: `wit/octoclaw/tools/v1/*.wit`
- Create: `wit/octoclaw/providers/v1/*.wit`
...
fn manifest_rejects_incompatible_wit_major() {
    let m = PluginManifest { wit_package: "octoclaw:hooks@2.0.0".into(), ..Default::default() };
