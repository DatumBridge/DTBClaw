//! # OctoClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with OctoClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  OctoClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use octoclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of OctoClaw. It defines its own
//! `Tool` trait that is compatible with OctoClaw's but doesn't require it.
//!
//! ## Safety
//!
