...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=OCTOCLAW_GIT_SHORT_SHA");
    ...
    let short_sha = env::var("OCTOCLAW_GIT_SHORT_SHA")
        .ok()
    ...
    println!("cargo:rustc-env=OCTOCLAW_BUILD_VERSION={build_version}");
    println!(
        "cargo:rustc-env=OCTOCLAW_GIT_SHORT_SHA={}",
