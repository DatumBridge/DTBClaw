...
use octoclaw::providers::compatible::AuthStyle;
use octoclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use octoclaw::providers::compatible::OpenAiCompatibleProvider;
