# Συνεισφορά στο OctoClaw

Σας ευχαριστούμε για το ενδιαφέρον σας να συνεισφέρετε στο OctoClaw! Αυτός ο οδηγός θα σας βοηθήσει να ξεκινήσετε.
...
1. **Βρείτε ένα ζήτημα.** Αναζητήστε ζητήματα με την ετικέτα [`good first issue`](https://github.com/octoclaw-labs/octoclaw/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) — αυτά είναι σχεδιασμένα για νεοεισερχόμενους και περιλαμβάνουν το απαραίτητο πλαίσιο για να ξεκινήσετε γρήγορα.
...
Το OctoClaw υποστηρίζει κλιμακωτή διαχείριση μυστικών για την τοπική ανάπτυξη και την υγιεινή του CI.
...
2. **Αρχείο ρυθμίσεων** (`~/.octoclaw/config.toml`)
...
3. Γενικές μεταβλητές περιβάλλοντος (`OCTOCLAW_API_KEY`, `API_KEY`)
...
**OctoClaw** — Μηδενική επιβάρυνση. Κανένας συμβιβασμός. 🦀
