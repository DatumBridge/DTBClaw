...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'permissions.workspace_only_desc': 'When enabled, DatumBridge can only access files within the current workspace directory.',
    'permissions.allowed_roots': 'Allowed Folders',
    'permissions.allowed_roots_desc': 'Additional directories DatumBridge is permitted to access outside the workspace.',
    'permissions.forbidden_paths': 'Blocked Paths',
    'permissions.forbidden_paths_desc': 'Directories and files that DatumBridge is never allowed to access.',
    'permissions.allowed_commands': 'Allowed Commands',
    'permissions.allowed_commands_desc': 'Shell commands that DatumBridge is permitted to execute.',
    'permissions.add': 'Add',
  ...
  tr: {
    ...
    'permissions.workspace_only_desc': 'Etkinlestirildiginde, DatumBridge yalnizca mevcut calisma alani dizinindeki dosyalara erisebilir.',
    'permissions.allowed_roots': 'Izin Verilen Klasorler',
    'permissions.allowed_roots_desc': 'DatumBridge\'un calisma alani disinda erisebilecegi ek dizinler.',
    'permissions.forbidden_paths': 'Engellenen Yollar',
    'permissions.forbidden_paths_desc': 'DatumBridge\'un asla erisemeyecegi dizin ve dosyalar.',
    'permissions.allowed_commands': 'Izin Verilen Komutlar',
    'permissions.allowed_commands_desc': 'DatumBridge\'un calistirmasina izin verilen kabuk komutlari.',
  ...
  'zh-CN': {
    ...
    'permissions.workspace_only_desc': '启用后，DatumBridge 只能访问当前工作区目录中的文件。',
    'permissions.allowed_roots': '允许的文件夹',
    'permissions.allowed_roots_desc': 'DatumBridge 可以在工作区外访问的额外目录。',
    'permissions.forbidden_paths': '禁止的路径',
    'permissions.forbidden_paths_desc': 'DatumBridge 永远不能访问的目录和文件。',
    'permissions.allowed_commands': '允许的命令',
    'permissions.allowed_commands_desc': 'DatumBridge 可以执行的 Shell 命令。',
    'permissions.add': '添加',
