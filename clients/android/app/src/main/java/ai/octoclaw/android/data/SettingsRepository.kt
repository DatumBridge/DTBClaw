package ai.octoclaw.android.data
...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "octoclaw_settings")

/**
 * Repository for persisting OctoClaw settings.
 *
...
class SettingsRepository(private val context: Context) {
    ...
    val settings: Flow<OctoClawSettings> = context.dataStore.data
        .catch { exception ->
    ...
    suspend fun updateSettings(settings: OctoClawSettings) {
