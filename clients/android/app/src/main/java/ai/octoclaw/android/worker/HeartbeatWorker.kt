package ai.octoclaw.android.worker
...
class HeartbeatWorker(
    ...
    private suspend fun runHeartbeat() {
        // TODO: Connect to OctoClaw bridge
        // val bridge = OctoClawBridge
    ...
    private suspend fun runCronJob() {
        ...
        // OctoClawBridge.executeCronJob(jobId, prompt)
    ...
    private suspend fun runHealthCheck() {
        ...
        // val status = OctoClawBridge.getStatus()
    ...
    companion object {
        ...
        const val WORK_NAME_HEARTBEAT = "octoclaw_heartbeat"
