package ai.octoclaw.android.tile
...
/**
 * Quick Settings tile for OctoClaw.
 *
 * Allows users to:
 ...
 */
class OctoClawTileService : TileService() {
    ...
    private fun updateTile() {
        ...
        // val isRunning = OctoClawBridge.isRunning()
    ...
    private fun startAgent() {
        val intent = Intent(this, OctoClawService::class.java).apply {
    ...
    private fun stopAgent() {
        val intent = Intent(this, OctoClawService::class.java).apply {
            action = OctoClawService.ACTION_STOP
        }
        startService(intent)
    }
