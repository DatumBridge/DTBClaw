package ai.octoclaw.android.widget
...
import ai.octoclaw.android.R
import ai.octoclaw.android.service.OctoClawService

/**
 * Home screen widget for OctoClaw.
 *
 * Features:
 ...
 */
class OctoClawWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TOGGLE = "ai.octoclaw.widget.TOGGLE"
        const val ACTION_QUICK_MESSAGE = "ai.octoclaw.widget.QUICK_MESSAGE"
        ...
        internal fun updateAppWidget(
            ...
            // Create RemoteViews
            val views = RemoteViews(context.packageName, R.layout.widget_octoclaw)
            ...
            // Toggle button
            val toggleIntent = Intent(context, OctoClawWidget::class.java).apply {
        ...
        fun requestUpdate(context: Context) {
            val intent = Intent(context, OctoClawWidget::class.java).apply {
