# OctoClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for OctoClaw edge scenarios on ESP32.
...
3. Connect UI state with OctoClaw edge/runtime messaging
...
- [OctoClaw Hardware Design](../../docs/hardware-peripherals-design.md)
