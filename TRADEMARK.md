# OctoClaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** OctoClaw Labs

---

## Our Trademarks

The following are trademarks of OctoClaw Labs:

- **OctoClaw** (word mark)
- **octoclaw-labs** (organization name)
- The OctoClaw logo and associated visual identity

These marks identify the official OctoClaw project and distinguish it from
...
The **only** official OctoClaw repository is:

> https://github.com/octoclaw-labs/octoclaw

Any other repository, organization, domain, or product claiming to be
"OctoClaw" or implying affiliation with OctoClaw Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/octoclaw` — not affiliated with OctoClaw Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/octoclaw-labs/octoclaw/issues.

---

## Permitted Uses

You **may** use the OctoClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   OctoClaw, provided it is clear your project is not the official OctoClaw.

2. **Descriptive reference** — referring to OctoClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of OctoClaw"
...
You **may not** use the OctoClaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by OctoClaw Labs.

2. **Cause brand confusion** — use "OctoClaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official OctoClaw project.

4. **Misrepresent origin** — remove or obscure attribution to OctoClaw Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from OctoClaw Labs.
...
you fork OctoClaw, you must:

- Clearly state your project is a fork of OctoClaw
- Link back to the official repository
- Not use "OctoClaw" as the primary name of your fork
...
Contributors to the official OctoClaw repository are protected under the
...
If you believe someone is infringing OctoClaw trademarks:

1. Open an issue at https://github.com/octoclaw-labs/octoclaw/issues
...
OctoClaw Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the OctoClaw name and brand.*
