//! Example: Implementing a custom Memory backend for OctoClaw
//!
...
// ── Re-define the trait types (in your app, import from octoclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 OctoClaw Memory Demo — InMemoryBackend\n");
